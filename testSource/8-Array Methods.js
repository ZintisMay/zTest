...
`,
      tests: [
        {
          description: `all variables and functions are declared (reset if red)`,
          test: () => {
        ...
        {
          description: `row2 is ['O', 'O', 'O']`,
          test: () => {
            expect(row2).toBeSameArrayAs(['O', 'O', 'O']);
          },
        },
        {
          description: `row3 is ['O', 'O', 'O']`,
          test: () => {
            expect(row3).toBeSameArrayAs(['O', 'O', 'O']);
          },
        },
        {
          // THESE STAY NEAR THE END SO THE OTHER TESTS DON"T GET WRECKED BY THE MUTATIONS
          description: `calls splice`,
          test: () => {
            expect(fixArrays)
              .withArgs()
        ...
        {
          description: `calls splice 3 times`,
          test: () => {
            expect(fixArrays)
              .withArgs()
