...
function add3ToArray(arr, str){
  // Write your code in here!
        ...
        tests: [
          ...
          { description: `use arr.push( ) three times`, test: () => {
            expect(add3ToArray)
              .withArgs(arr, 'ho')
              .callsFunction(Array.prototype, 'push', 3);
          } },
          { description: `add3ToArray returns something`, test: () => {
      ...
      Example: popTwice(['a', 'b', 'c']) returns ['a']`,
        ...
        tests: [
          ...
          { description: `uses arr.pop( )`, test: () => {
            expect(popTwice)
              .withArgs(['a', 'b', 'c'])
              .callsFunction(Array.prototype, 'pop');
          } },
          { description: `uses arr.pop( ) twice`, test: () => {
            expect(popTwice)
              .withArgs(['a', 'b', 'c'])
              .callsFunction(Array.prototype, 'pop', 2);
          } },
          { description: `return something`, test: () => {
            expect(popTwice).withArgs(['a', 'b', 'c']).toReturnSomething();
          } },
          { description: `return array`, test: () => {
            expect(popTwice).withArgs(['a', 'b', 'c']).toReturnArray();
          } },
          { description: `returns the remaining array`, test: () => {
      ...
      Example: reverseArray(['a', 'b', 'c']) returns ['c','b','a']`,
        ...
        tests: [
          ...
          { description: `calls array.reverse( )`, test: () => {
            expect(reverseArray)
              .withArgs([])
          ...
          { description: `returns the correct result (i.e. ['c', 'b', 'a'] returns ['a', 'b', 'c'])`, test: () => {
      ...
      Example: sortFruits(['banana', 'apple', 'cherry']) returns ['apple', 'banana', 'cherry']`,
        ...
        tests: [
          ...
          { description: `uses arr.sort( )`, test: () => {
            expect(sortFruits)
          ...
          { description: `returns the correct result (i.e. ['banana', 'apple', 'cherry'] returns ['apple', 'banana', 'cherry'])`, test: () => {
...
`,
      ...
      { type: 'lesson', key: 'lesson-finding',
...
`,
      ...
      Example: hasItem(['a', 'b', 'c'], 'b') returns true`,
        ...
        tests: [
          ...
          { description: `uses arr.includes( )`, test: () => {
            expect(hasItem)
              .withArgs(['a', 'b', 'c'], 'b')
      ...
      Example: getIndex(['a', 'b', 'c'], 'b') returns 1`,
        ...
        tests: [
          ...
          { description: `uses arr.indexOf( )`, test: () => {
            expect(getIndex)
              .withArgs(['a', 'b', 'c'], 'b')
      ...
      Example: findOver10([3, 15, 8, 20]) returns 15`,
        ...
        tests: [
          ...
          { description: `uses arr.find( )`, test: () => {
            expect(findOver10)
              .withArgs([3, 15, 8, 20])
      ...
      Example: findIndexOver10([3, 15, 8, 20]) returns 1`,
        ...
        tests: [
          ...
          { description: `uses arr.findIndex( )`, test: () => {
      ...
      { type: 'lesson', key: 'lesson-shift-unshift',
...
`,
      ...
      Example: replaceFirst(['a', 'b', 'c'], 'z') returns ['z', 'b', 'c']`,
        ...
        tests: [
          ...
          { description: `uses arr.shift( )`, test: () => {
            expect(replaceFirst)
              .withArgs(['a', 'b', 'c'], 'z')
              .callsFunction(Array.prototype, 'shift');
          } },
          { description: `uses arr.unshift( )`, test: () => {
            expect(replaceFirst)
              .withArgs(['a', 'b', 'c'], 'z')
              .callsFunction(Array.prototype, 'unshift');
          } },
          { description: `returns the correct result (i.e. replaceFirst(['a', 'b', 'c'], 'z') returns ['z', 'b', 'c'])`, test: () => {
...
`,
      ...
      Example: combineArrays([1, 2], [3, 4]) returns [1, 2, 3, 4]`,
        ...
        tests: [
          ...
          { description: `uses arr.concat( )`, test: () => {
          ...
          { description: `returns the correct result (i.e. combineArrays([1, 2], [3, 4]) returns [1, 2, 3, 4])`, test: () => {
            expect(combineArrays([1, 2], [3, 4])).toBeSameArrayAs([1, 2, 3, 4]);
          } },
          { description: `returns the correct result (i.e. combineArrays(['a', 'b'], ['c', 'd']) returns ['a', 'b', 'c', 'd'])`, test: () => {
...
var middle;`,
        tests: [
          { description: `letters is still ['a', 'b', 'c', 'd', 'e'] (reset if red)`, test: () => {
            expect(letters).toBeSameArrayAs(['a', 'b', 'c', 'd', 'e']);
          } },
          { description: `firstTwo is ['a', 'b']`, test: () => {
            expect(firstTwo).toBeSameArrayAs(['a', 'b']);
          } },
          { description: `lastTwo is ['d', 'e']`, test: () => {
            expect(lastTwo).toBeSameArrayAs(['d', 'e']);
          } },
          { description: `middle is ['b', 'c', 'd']`, test: () => {
